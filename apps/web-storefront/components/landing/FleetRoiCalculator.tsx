...
export default function RoiCalculator({ isLight = false }: RoiCalculatorProps) {
  ...
  return (
    <div
      className={`p-4 sm:p-8 lg:p-10 rounded-2xl border shadow-2xl relative overflow-hidden w-full ${
        isLight ? "bg-white border-gray-200" : "bg-[#0E1520]/95 border-cyan/30"
      }`}
    >
      {/* Subtle Ambient Glow */}
      ...
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 pb-5 border-b border-gray-800/80 gap-4">
        <div>
          ...
          <h2 className={`text-2xl sm:text-3xl font-black font-cyber ${isLight ? "text-black" : "text-white"}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div
          className={`lg:col-span-6 p-6 sm:p-8 rounded-2xl border flex flex-col justify-between ${
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 font-mono text-xs mb-6">
              ...
              >
                ...
                <span className="text-lg font-bold text-[#2DE1C2]">{annualROI}%</span>
              </div>
              <div
                className={`p-3 rounded-lg border ${
                  isLight ? "bg-white border-gray-200" : "bg-black/40 border-gray-800"
